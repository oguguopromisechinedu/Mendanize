  ...
  return (
    <main id="top" className="min-h-screen overflow-hidden bg-white text-slate-950">
      <section className="relative min-h-[680px] bg-[#061b2d] text-white">
        <div className="absolute inset-0 bg-[length:180%_auto] bg-[85%_top] bg-no-repeat" style={{ backgroundImage: "url(https://hebbkx1anhila5yf.public.blob.vercel-storage.com/ChatGPT%20Image%20Sep%2021%2C%202026%2C%2003_08_40%20AM-AlEBGeUABQsamcdUWUia9HGrS8FBlv.png)" }} aria-hidden="true" />
        <div className="absolute inset-0 bg-[linear-gradient(90deg,#061b2d_0%,#061b2d_48%,rgba(4,18,35,.72)_67%,rgba(4,18,35,.2)_100%)]" />
        <div className="absolute inset-0 bg-[linear-gradient(180deg,rgba(3,18,34,.82)_0%,rgba(3,18,34,.18)_30%,transparent_58%,rgba(3,18,34,.5)_100%)]" />
      ...
      <section id="paths" className="mx-auto max-w-7xl px-6 py-20 lg:px-10 lg:py-28">
        ...
        <div className="mt-12 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {paths.map(({ label, description, icon: Icon, color }) => <a key={label} href="#community" className="group overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm transition hover:-translate-y-1 hover:shadow-xl"><div className="h-28 bg-cover bg-center" style={{ backgroundImage: "url(https://hebbkx1anhila5yf.public.blob.vercel-storage.com/ChatGPT%20Image%20Sep%2021%2C%202026%2C%2003_08_40%20AM-AlEBGeUABQsamcdUWUia9HGrS8FBlv.png)" }} aria-hidden="true" /><div className="p-6"><div className={`-mt-12 mb-8 grid size-12 place-items-center rounded-xl border-4 border-white bg-slate-50 ${color}`}><Icon className="size-6" /></div><h3 className="text-xl font-semibold">{label}</h3><p className="mt-3 min-h-14 text-sm leading-6 text-slate-500">{description}</p><span className="mt-7 inline-flex items-center gap-2 text-sm font-semibold text-slate-900">Explore {label} <ArrowRight className="size-4 transition-transform group-hover:translate-x-1" /></span></div></a>)}
        </div>
      </section>
