      ...
      <div className="mx-auto max-w-6xl space-y-8">
        <header>
          ...
          <h1 className="mt-2 text-3xl font-bold tracking-tight text-white sm:text-4xl">
            Manage your editorial pipeline
          </h1>
          <p className="mt-2 text-slate-400">
            Track ideas, drafts, and publishing dates with a clear, actionable workflow.
          </p>
        </header>
        ...
        <section className="grid gap-6 lg:grid-cols-[1.2fr_0.8fr]">
          <div className={`${styles.glass} p-6`}>
            <div className="flex items-start justify-between gap-4">
              <div>
                <p className="text-sm uppercase tracking-[0.2em] text-slate-500">Content calendar</p>
          ...
          <div className={`${styles.glass} p-6`}>
            ...
            <h2 className="mt-2 text-xl font-semibold text-white">Content status overview</h2>
