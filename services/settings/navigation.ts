...
export const SEEDED_NAVIGATION_CONFIG: NavigationConfig = {
  ...
  social: [
    { label: "X", href: "https://x.com/mendanize" },
    { label: "LinkedIn", href: "https://www.linkedin.com/company/mendanize" },
    { label: "GitHub", href: "https://github.com/mendanize" },
    { label: "YouTube", href: "https://www.youtube.com/@mendanize" },
  ],
  popularTopics: [
